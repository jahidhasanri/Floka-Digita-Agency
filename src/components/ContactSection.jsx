...
const ContactSection = () => {
  ...
  return (
    <div className="mx-4 xl:mx-5 rounded-2xl px-4 md:px-8 xl:px-10 py-12 xl:py-20 bg-[url('/images/bg-img.png')] bg-cover bg-center">
      
      <div
        ref={sectionRef}
        className="max-w-331 mx-auto rounded-3xl text-white grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20"
      >
        ...
        <div>
          ...
          <h2 className="text-2xl md:text-3xl lg:text-[48px] font-semibold leading-tight mt-6 mb-10 lg:mb-16">
            Tell us about your project <br />
            — whether it’s a website, <br />
            SEO, or marketing.
          </h2>

          <div className="flex flex-col md:flex-row md:gap-20 lg:gap-44 gap-8">
        ...
        <div className="bg-white text-black p-6 md:p-8 xl:p-10 rounded-3xl">
