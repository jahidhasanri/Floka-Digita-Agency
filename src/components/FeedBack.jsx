...
const FeedBack = () => {
  return (
    <div className="max-w-331 mx-auto py-16 xl:py-20 px-4 xl:px-0">
      ...
      <h2 className="text-3xl md:text-4xl xl:text-5xl font-medium leading-tight max-w-full xl:max-w-205 xl:ml-auto mb-14 xl:mb-20">
        ...
        <span className="inline-flex mx-3">
          ...
          <img
            className="w-8 h-8 md:w-10 md:h-10 rounded-full border-2 border-white -ml-2"
            src="/images/girl.jpg"
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div className="group space-y-2">
          ...
          <div className="relative p-6 rounded-3xl bg-white h-64 xl:h-72 overflow-hidden">
            ...
            <div className="relative z-10 space-y-4 group-hover:text-white">
              ...
              <p className="font-semibold text-[16px] md:text-[18px] mb-10 xl:mb-28">
